...
#Save plot data
#saveRDS(H1_adj_nofever_plot_data, paste0(dropboxDir,"results/stress-growth-models/figure-data/H1_adj_nofever_spline_data.RDS"))
...
#Save plot data
#saveRDS(H2_plot_data, paste0(dropboxDir,"results/stress-growth-models/figure-data/H2_adj_nofever_spline_data.RDS"))
...
#Save plot data
#saveRDS(H3_plot_data, paste0(dropboxDir,"results/stress-growth-models/figure-data/H3_adj_nofever_spline_data.RDS"))
...
delta_growth_adj_nofever_res$adjusted <- 0
...
#Save plot data
#saveRDS(delta_growth_adj_nofever_plot_data, paste0(dropboxDir,"results/stress-growth-models/figure-data/delta_growth_adj_nofever_adj_nofever_spline_data.RDS"))
